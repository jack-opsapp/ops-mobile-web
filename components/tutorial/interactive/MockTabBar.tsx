          ...
          <div key={tab.id} className="flex flex-col items-center flex-1" style={{ gap: 4, paddingTop: 10 }}>
            ...
            <div
              style={{
                ...
                height: 3,
                borderRadius: 1.5,
                background: isActive ? '#FF7733' : 'transparent',
                marginBottom: 4,
            ...
            <span
              ...
              style={{
                fontSize: 12,
                color: isActive ? '#FF7733' : 'rgba(167, 167, 167, 0.8)',
...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" style={{ color: active ? '#FF7733' : 'rgba(167, 167, 167, 0.8)' }}>
